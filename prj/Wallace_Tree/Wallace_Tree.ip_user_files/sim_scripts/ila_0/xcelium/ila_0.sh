...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../Wallace_Tree.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../Wallace_Tree.gen/sources_1/ip/ila_0/hdl/verilog" \
